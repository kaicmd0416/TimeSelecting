...
class DataChecker:
    ...
    def _setup_logging(self):
        ...
        log_filename = "timeSelectingChecking.log"
        ...
        self.logger = gt2.GetLogger(
            logger_name="TimeSelecting",
    ...
    def check_signal_data(self, signal_name):
        ...
        try:
            ...
            return 'error', None
    def analyzer(self):
        feishu_url = os.getenv('FEISHU_WEBHOOK_URL_log')
        log_analyzer = gt2.Analyzer(self.log_path,feishu_url)
        log_analyzer.send_feishu_notification(project_name='TimeSelecting')
if __name__ == "__main__":
    ...
    # log_analyzer = gt2.Analyzer(r'D:\TimeSelecting\data_check\reports\timeSelectingChecking.log', 'https://open.feishu.cn/open-apis/bot/v2/hook/3f9f6458-c5e8-40de-95f0-d5bf9180c79e')
    # log_analyzer.send_feishu_notification(project_name='TimeSelecting')
